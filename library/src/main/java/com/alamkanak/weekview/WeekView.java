...
public class WeekView extends View {
    ...
    private void cacheEvent(WeekViewEvent event) {
        ...
        if (!isSameDay(event.getStartTime(), event.getEndTime())) {
            ...
            WeekViewEvent event1 = new WeekViewEvent(event.getId(), event.getName(), event.getLocation(), event.getStartTime(), endTime,event.getIdbd());
            ...
            while (!isSameDay(otherDay, event.getEndTime())) {
                ...
                WeekViewEvent eventMore = new WeekViewEvent(event.getId(), event.getName(), overDay, endOfOverDay,event.getIdbd());
            ...
            WeekViewEvent event2 = new WeekViewEvent(event.getId(), event.getName(), event.getLocation(), startTime, event.getEndTime(),event.getIdbd());
